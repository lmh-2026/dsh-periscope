...
**通用文件附件卡片**（输入框附件条 / 历史消息同款，Codex 风格）

| 修改前 | 修改后 |
| --- | --- |
| <img src="assets/attachment-before.png" width="220" alt="旧版：文档纸张 + 外框" /> | <img src="assets/attachment-card.png" width="420" alt="新版：自然附件卡片" /> |

> 左侧为初版样式（文档纸张图标 + 厚重外框）；右侧为当前版本——圆角 App 图标（品牌字母 W/X/P…）+ 文件名 + 类型/大小两行小字 + 常显删除按钮，像软件原生组件一样自然。
